...
class AppleSignInDemo extends StatefulWidget {
  const AppleSignInDemo({super.key});

  @override
  State<AppleSignInDemo> createState() => _AppleSignInDemoState();
}

class _AppleSignInDemoState extends State<AppleSignInDemo> {
  @override
