class InterpreterModel {
  ...
  InterpreterModel({this.status, this.errNum, this.msg, this.interpreters});

  InterpreterModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    errNum = json['errNum'];
    msg = json['msg'];
...
class Interpreters {
  ...
  Interpreters.fromJson(Map<String, dynamic> json) {
    ...
    ratingsAvgRating = json['ratings_avg_rating'].toString() ?? "";
    country =
