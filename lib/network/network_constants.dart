class NetworkConstants {
  ...
  static const String verifyOTP = "verify-email/verify-user-email";
  ...
  static const String showDream = '${NetworkConstants.baseUrl}show-dream/'; // no. of dream
  static const String addDream = '${NetworkConstants.baseUrl}add-dream';
  static const String addDreamComment = '${NetworkConstants.baseUrl}add-dream-comment';

  static const String favourite = '${NetworkConstants.baseUrl}favorites'; // get, add, delete
  ...
  static const String updatePassword = '${NetworkConstants.baseUrl}update-password';
